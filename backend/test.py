...
class TestFlow(unittest.TestCase):
    ...
    def testGenerarResenia(self):
        ...
        cantidad_original = requests.get('http://127.0.0.1:5050/resenias').json()['cantidad']
        
        data = {
            "email": "p.lopez@gmail.com",
            "comentario": f"""Increible {cantidad_original}""",
            "puntuacion": 4,
            "cabaña": "Amapola"
        }
        ...
        self.assertEqual(cantidad_original + 1, response['cantidad'])
